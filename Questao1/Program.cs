...
namespace Questao1 {
    class Program {
        static void Main(string[] args) {
            ...
            //Garantir exibição numérica americana conforme exemplo
            Thread.CurrentThread.CurrentCulture = new CultureInfo("en-US");

            Console.WriteLine();
            Console.WriteLine("Dados da conta:");
            Console.WriteLine($"Conta {conta.GetNumero()}, Titular: {conta.Titular}, Saldo: $ {String.Format("{0:0.00}", conta.Saldo)}");
